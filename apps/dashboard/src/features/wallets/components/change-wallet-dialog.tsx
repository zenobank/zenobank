...
export function ChangeWalletDialog({ 
  ...
  const onSubmit = (values: WalletForm) => {
    // Aquí irías la lógica para cambiar la wallet activa
    console.log('New wallet address:', values.walletAddress)
  ...
  return (
    ...
    >
      <DialogContent className='sm:max-w-md'>
        <DialogHeader>
          <DialogTitle>Change Active Wallet</DialogTitle>
          <DialogDescription>
            Enter the wallet address you want to set as active.
          </DialogDescription>
        </DialogHeader>
