          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div
                ...
                onClick={() => handleCopy(attempt.depositAccountId)}
              >
                <span className="block text-center font-mono text-sm break-all">{attempt.depositAccountId}</span>
              </div>
            </div>
            ...
            <div className="flex justify-center">
              <QRCodeCanvas
                ...
                value={attempt.depositAccountId}
                size={150}
                marginSize={1}
                bgColor="#ffffff"
                fgColor="#000000"
